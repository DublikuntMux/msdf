...
#include "core/SignedDistance.hpp"
#include "core/Vector2.hpp"

namespace msdfgen {
// Parameters for iterative search of closest point on a cubic Bezier curve. Increase for higher precision.
#define MSDLIB_CUBIC_SEARCH_STARTS 4
#define MSDLIB_CUBIC_SEARCH_STEPS 4
...
public:
  ...
  /// Outputs a list of (at most three) intersections (their X coordinates) with an infinite horizontal scanline at y
