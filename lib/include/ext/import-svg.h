...
#ifndef MSDLIB_EXT_PUBLIC
#define MSDLIB_EXT_PUBLIC 
#endif

namespace msdfgen {

extern MSDLIB_EXT_PUBLIC const int SVG_IMPORT_FAILURE;
extern MSDLIB_EXT_PUBLIC const int SVG_IMPORT_SUCCESS_FLAG;
extern MSDLIB_EXT_PUBLIC const int SVG_IMPORT_PARTIAL_FAILURE_FLAG;
extern MSDLIB_EXT_PUBLIC const int SVG_IMPORT_INCOMPLETE_FLAG;
extern MSDLIB_EXT_PUBLIC const int SVG_IMPORT_UNSUPPORTED_FEATURE_FLAG;
extern MSDLIB_EXT_PUBLIC const int SVG_IMPORT_TRANSFORMATION_IGNORED_FLAG;
