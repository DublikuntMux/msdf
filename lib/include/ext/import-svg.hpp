...
extern const int SVG_IMPORT_FAILURE;
extern const int SVG_IMPORT_SUCCESS_FLAG;
extern const int SVG_IMPORT_PARTIAL_FAILURE_FLAG;
extern const int SVG_IMPORT_INCOMPLETE_FLAG;
extern const int SVG_IMPORT_UNSUPPORTED_FEATURE_FLAG;
extern const int SVG_IMPORT_TRANSFORMATION_IGNORED_FLAG;
